    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div><h1 className="text-3xl font-bold">Add Location</h1><p className="text-muted-foreground">Create a new location record</p></div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-6">
            ...
            <div className="flex justify-end space-x-4">
              ...
              <Button type="submit" disabled={loading}><Save className="h-4 w-4 mr-2" />{loading ? "Saving..." : "Save Location"}</Button>
            </div>
          </div>
        </form>
      </div>
